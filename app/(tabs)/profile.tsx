...
const styles = StyleSheet.create({
  ...
  heroIdentity: { flexDirection: 'row', alignItems: 'center', gap: 16, flex: 1, minWidth: 0, flexWrap: 'wrap' },
  ...
  personalCard: { flex: 1.05, minWidth: 0, flexBasis: 320, backgroundColor: '#ffffff', borderColor: '#d1d5db' },
  sideStack: { flex: 1, minWidth: 0, flexBasis: 300, gap: 16 },
  ...
  editActions: { flexDirection: 'row', justifyContent: 'flex-end', flexWrap: 'wrap', gap: 10, marginTop: 4 },
